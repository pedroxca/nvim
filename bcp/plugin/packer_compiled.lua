...
_G.packer_plugins = {
  ...
  darcula = {
    loaded = true,
    path = "/home/vagrant/.local/share/nvim/site/pack/packer/start/darcula",
    url = "https://github.com/doums/darcula"
  },
  fd = {
    loaded = true,
    path = "/home/vagrant/.local/share/nvim/site/pack/packer/start/fd",
  ...
  ["nlsp-settings.nvim"] = {
    loaded = true,
    path = "/home/vagrant/.local/share/nvim/site/pack/packer/start/nlsp-settings.nvim",
  ...
  ["nvim-ts-context-commentstring"] = {
    loaded = true,
    path = "/home/vagrant/.local/share/nvim/site/pack/packer/start/nvim-ts-context-commentstring",
  ...
  ["onedarkpro.nvim"] = {
    loaded = true,
    path = "/home/vagrant/.local/share/nvim/site/pack/packer/start/onedarkpro.nvim",
  ...
  ["telescope-media-files.nvim"] = {
    loaded = true,
    path = "/home/vagrant/.local/share/nvim/site/pack/packer/start/telescope-media-files.nvim",
  ...
  ["vim-bbye"] = {
    loaded = true,
    path = "/home/vagrant/.local/share/nvim/site/pack/packer/start/vim-bbye",
